...
CREATE TABLE `quoteitem` (
  ...
  KEY `part_id` (`part_id`),
  CONSTRAINT `quoteitem_ibfk_1` FOREIGN KEY (`quote_id`) REFERENCES `quote` (`id`) ON DELETE CASCADE,
  CONSTRAINT `quoteitem_ibfk_2` FOREIGN KEY (`part_id`) REFERENCES `part` (`id`)
...
INSERT INTO `quoteitem` VALUES (120,37,2,1,199.99);
