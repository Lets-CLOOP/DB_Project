...
CREATE TABLE `usecase` (
  ...
  `weight_cpu` decimal(3,2) NOT NULL DEFAULT '1.00',
  `weight_gpu` decimal(3,2) NOT NULL DEFAULT '1.00',
  `weight_ram` decimal(3,2) NOT NULL DEFAULT '1.00',
  `weight_storage` decimal(3,2) NOT NULL DEFAULT '1.00',
  PRIMARY KEY (`use_case`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='weighting by UseCase';
